...
public class webTablePagination {
	...
	public void test() throws InterruptedException {
		...
		//List <WebElement> cols = table.findElements(By.xpath("//table[@id='users']/thead//th"));
	...
	private void printTableData(WebElement table) {
		for(int i=1;i<6;i++) {
			for(int j=1;j<8;j++) {
				WebElement getCellData = driver.findElement(By.xpath("//*[@class='content']//table//tr["+i+"]/td["+j+"]"));
